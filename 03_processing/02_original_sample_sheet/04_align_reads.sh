...
# Samtools reports on the indexed bam files
samtools flagstat ${dedup_bam} > ${dedup_bam}_flagstat_report.txt
samtools stats ${dedup_bam} > ${dedup_bam}_stats_report.txt