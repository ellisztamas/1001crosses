...
# SLURM
#SBATCH --job-name=sum_background
#SBATCH --output=05_results/11_sim_background/slurm/%x-%a.out
#SBATCH --error=05_results/11_sim_background/slurm/%x-%a.err
#SBATCH --mem=1GB
#SBATCH --qos=rapid
#SBATCH --time=1:00:00
#SBATCH --array=0-1199
...
file_array=( $(cat /scratch-cbe/users/thomas.ellis/crosses/05_results/11_sim_background/pheno_file_list.txt) )
