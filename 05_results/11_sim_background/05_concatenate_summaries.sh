...
#SBATCH --output=05_results/11_sim_background/slurm/%x.out
#SBATCH --error=05_results/11_sim_background/slurm/%x.err
#SBATCH --mem=5GB
#SBATCH --qos=rapid
#SBATCH --time=20:00
...
indir=/scratch-cbe/users/thomas.ellis/crosses/05_results/11_sim_background
file_array=($indir/*/*/*/*/sim_summary.txt)

# === Output === #

outfile=05_results/11_sim_background/output/simulation_summary.csv
