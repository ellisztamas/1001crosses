...
# SLURM
#SBATCH --job-name=sim_case_controls
#SBATCH --output=05_results/10_sim_case_controls/slurm/%x-%a.out
#SBATCH --error=05_results/10_sim_case_controls/slurm/%x-%a.err
#SBATCH --mem=5GB
#SBATCH --qos=short
#SBATCH --time=4:00:00
#SBATCH --array=1200-2399
...
file_array=( $(cat /scratch-cbe/users/thomas.ellis/crosses/05_results/10_sim_case_controls/pheno_file_list.txt) )
