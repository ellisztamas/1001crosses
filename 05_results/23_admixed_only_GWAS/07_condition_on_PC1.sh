...
# lines, but including PC1 of genetic variation in the QTL region as a covariate.
#
# Tom Ellis, 16th October 2025

# SLURM
#SBATCH --job-name=07_condition_on_PC1
...
# Text file giving a column of 1s and covariate values.
covariate_file=05_results/23_admixed_only_GWAS/output/Chr5_QTL_region_PC1.tsv
...
outdir=05_results/23_admixed_only_GWAS/output/07_condition_on_PC1
mkdir -p $outdir
