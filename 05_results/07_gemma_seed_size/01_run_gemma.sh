...
# Run a vanilla univariate GWA using GEMMA on seed size with and without a
# kinship matrix of relatedness. 
# 
...
# SLURM
#SBATCH --job-name=seed_size_gemma
...
with_K=05_results/07_gemma_seed_size/output/with_K
mkdir -p $with_K
without_K=05_results/07_gemma_seed_size/output/without_K
mkdir -p $without_K
