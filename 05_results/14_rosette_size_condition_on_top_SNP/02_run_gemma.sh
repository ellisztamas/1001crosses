...
# Run univariate GWA using GEMMA on rosette size with and without a
# kinship matrix, including the mostly strongly associated SNP as a covariate.
#
...
#     Text file giving a vector of zeroes and the genotype at the most strongly
#         associated SNP
# Output:
...
# SLURM
#SBATCH --job-name=rosette_size_conditional
...
covariate_file="05_results/14_rosette_size_condition_on_top_SNP/output/chr3_3738546.tsv"
...
outdir=05_results/14_rosette_size_condition_on_top_SNP/output
mkdir -p $outdir
